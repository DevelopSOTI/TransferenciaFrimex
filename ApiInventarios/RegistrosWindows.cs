...
namespace ApiInventarios
{
    ...
    public class RegistrosWindows
    {
        ...
        {
            get { return mysql_dominio; } set { mysql_dominio = value; }
        }
        public string MYSQL_USUARIO
        {
            get { return mysql_usuario; } set { mysql_usuario = value; }
        }
        public string MYSQL_PASS
        {
            set { mysql_pass = value; } get { return mysql_pass; }
        }
        public string MYSQL_PUERTO
        {
            set { mysql_puerto = value; } get { return mysql_puerto; }
        }
        public string MYSQL_BD
        {
            set { mysql_bd = value; } get { return mysql_bd; }
        }

        //Propiedades SQLServer
        public string SQL_USUARIO
        {
            get { return sql_usuario; } set { sql_usuario = value; }
        }
        public string SQL_PASSWORD
        {
            set { sql_password = value; } get { return sql_password; }
        }
        public string SQL_SERVIDOR
        {
            set { sql_servidor = value; } get { return sql_servidor; }
        }
        ...
        {
            get { return micro_user; } set { micro_user = value; }
        }
        public string MICRO_PASS
        {
            set { micro_pass = value; } get { return micro_pass; }
        }
        public string MICRO_SERVER
        {
            set { micro_server = value; } get { return micro_server; }
        }
        ...
        public string TRANSFERENCIA_ID { set; get; }
        ...
        public void LeerRegistros(string ruta_registros)
        {
            ...
            TRANSFERENCIA_ID = (string)rk2.GetValue("TRANSFERENCIA_ID");
            CONCEPTO = (string)rk2.GetValue("CONCEPTO");
